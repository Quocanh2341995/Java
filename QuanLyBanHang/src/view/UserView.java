...
public class UserView {
    ...
    public static void userMenu() {
        try {
            ...
            do {
                ...
                System.out.println("+------------------------------------------+");
                choice = AppUtils.getNumberMinMax("Chon lua chon:", 0, 6);
                switch (choice) {
                    case 1:
                        showUserAccount();
                        break;
    ...
    private static void changeStatusOrder() {
        ...
        String str = String.format("| %-7s | %-7s | %-8s | %-10s | %-10s | %-15s |",
                "Id","userId", "Product Id", "BuyDate", "Quantity", "Order Status");
        ...
        System.out.println("Nhap ma don hang muon chuyen doi trang thai:");
    ...
    private static void showOrderList() {
        ...
        System.out.println(String.format("| %-7s | %-7s | %-7s | %-10s | %-8s | %-13s |",
    ...
    private static void showUserAccount() {
        ...
        System.out.println("╔--------------------------------------- Danh sach tai khoan khach hang --------------------------------------╗");
